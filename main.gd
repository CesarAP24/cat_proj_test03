...
func crear_representacion_visual():
	...
	if DEBUG:
		...
		objetivo_especial.scale = Vector3(1, 1, 1)
...
func manejar_movimiento_objetivo():
	var velocidad_objetivo = 1
	punto_objetivo.y = obtener_centro().y+15
...
# --------------------
func debe_avanzar():
	return distancia(obtener_centro(), punto_objetivo) > UMBRAL_DISTANCIA
...
func calcular_siguiente_posicion_delantera(izquierda):
	...
	var pos = obtener_centro() + dir_norm * LONGITUD_PASO
